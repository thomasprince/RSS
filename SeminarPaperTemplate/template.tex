...
\begin{enumerate}[(1)]
	...
	\begin{figure}[h]
		\centering\includegraphics[width=0.5\linewidth]{figures/modelbased_metric.jpg}
...
\begin{enumerate}[(1)]
	...
	\begin{figure}[h]
		\centering
		\subfigure[1) Forge an employment card; 2) Forge an authorization; 3) Breaking and entering; 4) Pick the lock; 5) Standing in; 6) Manger delegation.]
